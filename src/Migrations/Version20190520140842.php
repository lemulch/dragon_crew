 ...
 */
final class Version20190520140842 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE spatial_center (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, locallization VARCHAR(255) NOT NULL, latitude NUMERIC(9, 6) NOT NULL, longitude NUMERIC(9, 6) NOT NULL, description LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE mission ADD CONSTRAINT FK_9067F23CBDA52D98 FOREIGN KEY (spacial_center_id) REFERENCES spatial_center (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE spatial_center');
    }
}
